...
@pytest.mark.parametrize("mock_sql_connect", ([("script_name",), [(123, "line_text", "type", "id")], [], []],), indirect=True)
...
@pytest.mark.parametrize("mock_sql_connect", ([("script_name",), [(123, "line_text", "type", "id1"), (8236, "line_text", None, None)], [], [], [], []],), indirect=True)
...
@pytest.mark.parametrize("mock_sql_connect", ([("script_name",), [(123, "line_text", "type", "id1"), (124, "line_text", None, None)], [], [], [], []],), indirect=True)
...
@pytest.mark.parametrize("mock_sql_connect", ([("script_name",), [(124, "line_text", "header", None)], [], [], [], []],), indirect=True)
