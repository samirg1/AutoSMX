...
def test_script_creation() -> None:
    script = Script("Nick", "Script Name", 1, "999TEST", "type", (), ())
...
def test_script_creation_with_extra_terms() -> None:
    script = Script("UniqueNick", "Unique Script", 1, "999TEST", "type", (), (), search_terms=["tag1", "tag2"])
    assert script.tester_number == "999TEST"
...
def test_script_matches(match_description: str, expected: bool) -> None:
    script = Script("Tester", "Matching Script", 1, "999TEST", "type", (), (), search_terms=["tag3"])
    assert script.is_for(match_description) == expected


def test_script_to_string() -> None:
    script = Script("MyNick", "Awesome Script", 1, "999TEST", "type", (), ())
    assert str(script) == "Awesome Script"


def test_hash_and_eq() -> None:
    script1 = Script("Nick1", "Script 1", 1, "999TEST", "type", (), ())
    script2 = Script("Nick2", "Script 2", 2, "999TEST", "type", (), ())
    script3 = Script("Nick3", "Script 1", 1, "999TEST", "type", (), ())
