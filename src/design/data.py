...
SCRIPTS: dict[str, Script] = {
    "CHANGE TILT TABLE": Script(
        "CHANGE TILT TABLE", "AT - CHANGE / TILT TABLE, ELECTRIC/MANUAL", 0, _CASTORS_Y, _FRAME, _PAINT, _LABELLING, _CHARGER_N, _BATTERY_N, _CONTROL, _CONDITION, _FURTHER_ATTENTION
    ),
    "SLING": Script("SLING", "AT - SLING", 1, _DETAILS, _GENERAL_WEAR, _STITCHING, _FITTINGS, _VELCRO_N, _LABELLING, _CONDITION),
    "WALKER": Script(
        "WALKER",
        "AT - WALKER / STANDER",
        2,
    ...
    "TRACK": Script("TRACK", "AT - TRACK", 4, _FEATURES, _TRACK_DUST, _CHARGER_N, _TRACK_LOAD_KG, _LOAD_TEST, _ELECTRIC_TEST),
    "COMMODE": Script("COMMODE", "AT - COMMODE", 5, _CASTORS_Y, _FRAME, _PAINT, _OPERATION, _LABELLING, _CHARGER_N, _BATTERY_N, _CONTROL, _CONDITION),
    "BED": Script("BED", "AT - ELECTRIC BED", 6, _CASTORS_Y, _FRAME, _HARDWARE, _CONTROL, _PAINT, _OPERATION, _LABELLING, _CHARGER_N, _HELP_POLE, _CONDITION),
    "FLOOR HOIST": Script(
        "FLOOR",
        "AT - FLOOR HOIST",
        7,
    ...
    "TUB": Script("TUB", "AT - TUB / BATH CHAIRS", 8, _CASTORS_Y, _FRAME, _PAINT, _OPERATION, _LABELLING, _CHARGER_N, _BATTERY_N, _CONTROL, _CONDITION, extra_terms=["BATH"]),
    "SCALE": Script("SCALE", "AT - WEIGH CHAIR / SCALE", 9, _CASTORS_Y, _FRAME, _PAINT, _OPERATION, _LABELLING, _CHARGER_N, _BATTERY_Y, _ACCURACY, _CONDITION, extra_terms=["WEIGH"]),
    "WHEELCHAIR": Script(
        "WHEELCHAIR",
        "AT - WHEELCHAIR",
        10,
    ...
    "CHARGER": Script("CHARGER", "BATTERY OPERATED / VISUAL TEST", 11, _BATTERY_N, _CONTROL, _VISUAL, _ATTACHMENTS),
    "BATTERY": Script("BATTERY", "BATTERY PACK", 12, _VISUAL, _CAPACITY, _DATE),
    "CLASS II": Script(
        "CLASS II",
    ...
    "FURNITURE": Script(
        "FURNITURE", "FURNITURE GENERIC", 14, _CONDITION, _CASTORS_Y, _CASTORS_Y, _PAINT, _CASTORS_Y, _MISSING_COMPONENTS, _POLES, _CLEAN, _ELECTRIC_N, _PERFORMANCE, extra_terms=["OVERBED"]
    ),
}
