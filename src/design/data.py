...
SCRIPT_INFOS = (
    ...
    ScriptInfo(1227, "9999TEST", "CEILING", {8291: NA, 8298: NA, 8303: NA, 8306: NO, 8304: NA}, exact_matches=("HOIST, CEILING", "LIFTS, PATIENT TRANSFER, OVERHEAD TRACK"), condition_line=8305, non_persistent_fields=(8304,)),
    ...
    ScriptInfo(605, "11083TEST", "CLASS I", {460: NA, 462: SPACE, 463: SPACE, 468: NA}, required_fields=(461, 464, 465, 466, 471, 472, 473, 474), non_persistent_fields=(461, 464, 465, 466, 471, 472, 473, 474)),
)
